  ...
  template: `
    <nav class="navbar">
      <div class="navbar-start">
        ...
        <div class="brand cursor-pointer" [routerLink]="['/']">BRICKS</div>
      </div>
      ...
      <div class="navbar-end">
        ...
        <a class="create-btn bg-[#3c77bd]" [routerLink]="['/create-document']"
          >Create</a
        >
        <div
          class="profile text-right flex gap-2 items-center"
          [dropdownTriggerFor]="dropdown"
        >
          <div>
            <h6 class="text-sm font-semibold">
              GONZALEZ PEREIRA MARTINS Jose Luís
            </h6>
